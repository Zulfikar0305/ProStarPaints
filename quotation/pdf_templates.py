...
PDF_TEMPLATES: dict[str, dict] = {
    ...
    "manual_specification": {
        ...
        "description": "Open the dedicated manual builder to override Preparation and Application for each quotation item while keeping the automatic specification as the base data source.",
        "best_for": "Per-item preparation and application edits without replacing the automatic specification engine.",
        "highlights": [
            "Per-item editing",
            "Keeps automatic data as the default",
            "Saves overrides for each section independently",
        ],
        "template_path": "quotation/pdf/manual_specification.html",
        "preview_label": "Builder",
