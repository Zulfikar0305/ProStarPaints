...
class QuotationPdfExport(models.Model):
    """
    Record of every PDF generated for a quotation.

    Tracks the template used, who generated it, the resulting file, and
    whether generation succeeded or failed.  Kept for audit/download history.
    """
    ...
    class Meta:
        ordering = ["-created_at"]
        verbose_name = _("quotation PDF export")
        verbose_name_plural = _("quotation PDF exports")
